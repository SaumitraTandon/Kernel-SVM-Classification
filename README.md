...
6. Trains a Kernel SVM model on the training set using the SVC class from scikit-learn. The kernel is set to 'rbf' (Radial Basis Function), and the `random_state` parameter is set to 0 for reproducibility.
7. Demonstrates how to predict a new result using the trained Kernel SVM model for an age of 30 and an estimated salary of 87,000.
